...
#+ bug598341,cdzk,20200921,camera bring up
CUSTOM_HAL_IMGSENSOR = ironman_qunhui_hi1336_mipi_raw ironman_dongci_hi1336_mipi_raw ironman_lianyi_gc5035_mipi_raw ironman_qunhui_gc5035_mipi_raw ironman_cxt_gc2375h_mipi_raw ironman_lh_gc2375h_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = ironman_cxt_gc2375h_mipi_raw ironman_lh_gc2375h_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = ironman_qunhui_hi1336_mipi_raw ironman_dongci_hi1336_mipi_raw
CUSTOM_HAL_SUB_IMGSENSOR = ironman_lianyi_gc5035_mipi_raw ironman_qunhui_gc5035_mipi_raw
#- bug598341,cdzk,20200921,camera bring up
#+ bug590447,cdzk,add,20200923,camera af bring up
CUSTOM_HAL_LENS = cn3927e
CUSTOM_HAL_MAIN_BACKUP_LENS = cn3927e
CUSTOM_HAL_MAIN_LENS = cn3927e
#- bug590447,cdzk,add,20200923,camera af bring up
...
#+ bug598341,cdzk,20200921,camera bring up
CUSTOM_KERNEL_IMGSENSOR = ironman_qunhui_hi1336_mipi_raw ironman_dongci_hi1336_mipi_raw ironman_lianyi_gc5035_mipi_raw ironman_qunhui_gc5035_mipi_raw ironman_cxt_gc2375h_mipi_raw ironman_lh_gc2375h_mipi_raw
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR = ironman_lh_gc2375h_mipi_raw
CUSTOM_KERNEL_MAIN2_IMGSENSOR = ironman_cxt_gc2375h_mipi_raw
CUSTOM_KERNEL_MAIN_IMGSENSOR = ironman_qunhui_hi1336_mipi_raw ironman_dongci_hi1336_mipi_raw
CUSTOM_KERNEL_SUB_IMGSENSOR = ronman_lianyi_gc5035_mipi_raw ironman_qunhui_gc5035_mipi_raw
#- bug598341,cdzk,20200921,camera bring up
#+ bug590447,cdzk,add,20200923,camera af bring up
CUSTOM_KERNEL_LENS = cn3927
CUSTOM_KERNEL_MAIN_BACKUP_LENS = cn3927e
CUSTOM_KERNEL_MAIN_LENS = cn3927e
#- bug590447,cdzk,add,20200923,camera af bring up
...
CUSTOM_MODEM=TK_MD_BASIC_LWTG_6177M_R3_6761_T99621AA3
...
MTK_BWC_SUPPORT = yes
#+Bug586756 liqiancheng.wt modify 20200916
MTK_C2K_LTE_MODE = 0
#-Bug586756 liqiancheng.wt modify 20200916
MTK_CAMERA_APP = no
...
#+bug590450 , cdzk, modify, 20201012, open mtkcamera dual camera stereo mode.
...
#ExtB IRM-18671, zhangkai6.wt, modify, 20201127, CtsBluetoothTestCases Fail 12
MTK_CTA_SET = no
MTK_CTA_SUPPORT = no
MTK_CTM_SUPPORT = no
...
#IRM-16378 limei1.wt modify 20200922
...
#+chk69011 xiangyujie.wt 20201027 add, support high resolution.
...
MTK_MUX_CHANNEL = 64
##+req IRM-17424 wanggang6.wt Should be able to connect Xcal,20201102,
...
#+Bug581553 wangguanyu.wt 20200920 Modify, config partition table.
...
#+bug584116 liqiancheng.wt 20200907 open sim_hot swap
...
# +bug595090,leiyun@wt,20201016,add,TEE porting
...
MTK_UCE_SUPPORT = no
MTK_UFS_OTP = no
#IRM-15568, sheqihao.wt, MODIFY, 20200609, fix LCD Backlight flicker
...
#+Extb IRM-18701 xiangyujie delete 20201116 no wma lisence,delete wma codec.
...
# +IRM17588,luohao,20201027,modify,DURASPEED does not show
...
#ExtB IRM-17201,wangbiao1.wt,modify,20201008, open RTT function
MTK_RTT_SUPPORT = yes
#chk49409 liqiancheng.wt, add,2021/01/21, SBP level
...
MTK_ESS_SUPPORT = yes
WT_INNER_VERSION=SW_T99621AA3_V037_M11_NF_NOKIA_Ironman_USR_MP
WT_PROJECT=T99621AA3
# +bug584769,wangyongfei.wt,20200923,add,sarsensor
USE_SENSOR_MULTI_HAL=true
# -bug584769,wangyongfei.wt,20200923,add,sarsensor

WT_PRODUCT_PROJECT=T99621
#Req chenhaibing.wt, add software version
#ExtR IRM-17580, tangke1.wt,20201022,modify,About the phone version numberdislay error
...
WT_PRODUCTION_ORI=V3.310_B01
WT_PRODUCTION_VERSION=V3.310_B01
